...
if __name__ == '__main__':
    m2m_data = {}
    with open('../CALL_Graph/Time_M2M.txt', 'r') as M_f:
        mf = M_f.readlines()
    for m2m in mf:
        name = m2m.split(' * ')[0]
        M2M = m2m.split(' * ')[1]
    ...
    with open('../pkl_data/Time.json', 'r') as rf:
        datas = json.load(rf)
    ...
    for data in datas:
        ...
        print('------rrrrrrrr--------')
        P_matrix , F_matrix= integration(method2method_matrix,method2lines_matrix,mutation2lines_matrix, lines2rtest_matrix,lines2ftest_matrix, mutation2rtest_matrix,mutation2ftest_matrix, len_method, len_lines,len_mutation, len_rtest, len_ftest)
        print('------ffffffff--------')
        ...
        P_file_path = f'''F_FIN_matrix/Time\{data_name}_matrix.pkl'''
        F_file_path = f'''P_FIN_matrix\Time\{data_name}_matrix.pkl'''
