...
def TOP_N(data_value,a,d):
    filepath = f'result/{data_value}/w_top_n_a={a}_d={d}.xlsx'
    f = openpyxl.Workbook()
    ...
    row0 = [' ', 'GP13', 'OCHIAI', 'Jaccard', 'OP2', 'TARANTULA','Dstar']
    ...
    for data in datas:
        ...
        formulas = ['GP13', 'Ochiai', 'Jaccard', 'OP2', 'Tarantula','Dstar']
        ...
        for formula in formulas:
            try:
                with open(f'{data_value}_SUS/PR_MBFL/{data_name}{formula}_sus_a={a}_d={d}.txt', 'r') as mbfl_f:
                    pr_mbfl_sus = key_value(eval(mbfl_f.readline()))
                    pr_mbfl_sus = max_sus(pr_mbfl_sus,mbfl_sus)
                    # top_1
    ...
    print('------------------------------------')
    data1 = [
        [mbfl_GP13_top_1, pr_mbfl_GP13_top_1, pr_mbfl_GP13_top_1 - mbfl_GP13_top_1],
        [mbfl_Ochiai_top_1, pr_mbfl_Ochiai_top_1, pr_mbfl_Ochiai_top_1 - mbfl_Ochiai_top_1],
        [mbfl_Jaccard_top_1, pr_mbfl_Jaccard_top_1, pr_mbfl_Jaccard_top_1 - mbfl_Jaccard_top_1],
        [mbfl_OP2_top_1, pr_mbfl_OP2_top_1, pr_mbfl_OP2_top_1 - mbfl_OP2_top_1],
    ...
    data2 = [
        [mbfl_GP13_top_3, pr_mbfl_GP13_top_3, pr_mbfl_GP13_top_3 - mbfl_GP13_top_3],
        [mbfl_Ochiai_top_3, pr_mbfl_Ochiai_top_3, pr_mbfl_Ochiai_top_3 - mbfl_Ochiai_top_3],
        [mbfl_Jaccard_top_3, pr_mbfl_Jaccard_top_3, pr_mbfl_Jaccard_top_3 - mbfl_Jaccard_top_3],
        [mbfl_OP2_top_3, pr_mbfl_OP2_top_3, pr_mbfl_OP2_top_3 - mbfl_OP2_top_3],
    ...
    data3 = [
        [mbfl_GP13_top_5, pr_mbfl_GP13_top_5, pr_mbfl_GP13_top_5 - mbfl_GP13_top_5],
        [mbfl_Ochiai_top_5, pr_mbfl_Ochiai_top_5, pr_mbfl_Ochiai_top_5 - mbfl_Ochiai_top_5],
        [mbfl_Jaccard_top_5, pr_mbfl_Jaccard_top_5, pr_mbfl_Jaccard_top_5 - mbfl_Jaccard_top_5],
        [mbfl_OP2_top_5, pr_mbfl_OP2_top_5, pr_mbfl_OP2_top_5 - mbfl_OP2_top_5],
...
def EXAM(data_value,a,d):
    filepath = f'result/{data_value}/EXAM_a={a}_d={d}.xlsx'
    f = openpyxl.Workbook()
        ...
        for data in datas:
            try:
                ...
                with open(f'{data_value}_SUS/MBFL/{data_name}{formula}_sus.txt', 'r') as mbfl_f:
                    ...
                    # print(mbfl_sus)
                    # print(rank )
                with open(f'{data_value}_SUS/PR_MBFL/{data_name}{formula}_sus.txt', 'r') as mbfl_f:
                    pr_mbfl_sus = key_value(eval(mbfl_f.readline()))
...
def MAR(data_value,a,d):
    filepath = f'result/{data_value}/MAR_a={a}_d={d}.xlsx'
    f = openpyxl.Workbook()
